...
cat(paste0(
  ...
  "is only modestly ahead of the **median Round 2 WR** (", round(med_wr_day2, 3),
  ", ~**$", round(med_wr_day2 * 275), "M**). The *best* RB outcome in our sample is in the same ballpark as an *average* Round 2 WR. ",
