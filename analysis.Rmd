...
### What About RB in the Top 10?

```{r rb-top10-table, results='asis'}
cat(paste0(
  ...
  "What does that look like in practice? Here are all ", nrow(player_lookup %>% filter(pos_group == "RB", pick <= 10, season <= 2022)),
...
cat(paste0(
  ...
  ") is solid. But **zero produced an elite return**. Even Christian McCaffrey — ",
  "arguably the best-case RB outcome in a generation — returned ",
  percent(max(top10_rb_data$player_return), accuracy = 0.1),
  ", still short of the ", percent(elite_threshold, accuracy = 0.1), " elite threshold.\n\n",

  "The opportunity cost is real. At these same pick slots, the positions that *do* produce ",
  "elite returns are QB, EDGE, and OT — the positions where top-10 Sharpe is positive."
))
```
