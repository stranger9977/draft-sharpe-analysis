...
cat(paste0(
  ...
  "; hitting on day-three picks is nice, but it does not separate teams in the standings."
))
```
...
make_player_gt <- function(data, title, subtitle = NULL) {
  tbl <- data %>%
    ...
    rename(drafted_by = team, second_team = second_contract_team) %>%
    # Normalize team codes for nflplotR wordmark rendering
    mutate(
      drafted_by = dplyr::recode(drafted_by,
        "GNB"="GB","KAN"="KC","NOR"="NO","NWE"="NE","SFO"="SF","TAM"="TB",
        "OAK"="LV","LVR"="LV","SD"="LAC","SDG"="LAC","STL"="LAR","LA"="LAR"),
      second_team = dplyr::recode(second_team,
        "Packers"="GB","Chiefs"="KC","Saints"="NO","Patriots"="NE","49ers"="SF",
        "Buccaneers"="TB","Raiders"="LV","Chargers"="LAC","Rams"="LAR",
        "Cardinals"="ARI","Falcons"="ATL","Ravens"="BAL","Bills"="BUF",
        "Panthers"="CAR","Bears"="CHI","Bengals"="CIN","Browns"="CLE",
        "Cowboys"="DAL","Broncos"="DEN","Lions"="DET","Texans"="HOU",
        "Colts"="IND","Jaguars"="JAX","Dolphins"="MIA","Vikings"="MIN",
        "Giants"="NYG","Jets"="NYJ","Eagles"="PHI","Steelers"="PIT",
        "Seahawks"="SEA","Titans"="TEN","Commanders"="WAS","Redskins"="WAS",
        "Football Team"="WAS")
    ) %>%
    select(rank, gsis_id, pfr_player_name, pos_group, second_team, drafted_by,
  ...
  tbl %>%
    ...
    gt_nfl_wordmarks(columns = "second_team", height = 25) %>%
    cols_label(
      rank = "",
      gsis_id = "",
      pfr_player_name = "PLAYER",
      pos_group = "POS",
      drafted_by = "2ND CONTRACT TEAM",
      second_team = "DRAFTED BY",
      season = "YEAR",
      pick = "PICK",
