...
```{r saquon-example, results='asis'}
saquon <- player_lookup %>% filter(grepl("Saquon", pfr_player_name))

cat(paste0(
  "Michael asked for a specific player to run through the numbers — Saquon Barkley is perfect ",
  "because he's one of the *best possible outcomes* for a top-10 RB, and he still doesn't crack ",
  "the elite threshold.\n\n",

  "**Saquon Barkley — Pick #2, 2018**\n\n",
  "| Metric | Value | What it means |\n",
  "|---|---|---|\n",
  "| Avg snap % | ", percent(saquon$avg_snap_pct, accuracy = 0.1),
    " | Averaged ", percent(saquon$avg_snap_pct, accuracy = 0.1),
    " of offensive snaps over first 4 years |\n",
  "| Snap ratio | ", round(saquon$snap_ratio, 2),
    " | That's ", round(saquon$snap_ratio, 2),
    "× the RB starter baseline — he was a hit |\n",
  "| Rookie deal APY | ", percent(saquon$rookie_apy_cap_pct, accuracy = 0.1),
    " | Cost of his rookie contract as % of cap |\n",
  "| FA median (RB) | ", percent(saquon$fa_median_apy_cap_pct, accuracy = 0.1),
    " | What a starting RB costs in free agency |\n",
  "| Rookie surplus | ", percent(saquon$rookie_surplus, accuracy = 0.1),
    " | 4 years of savings from paying a starter on a rookie deal |\n",
  "| Second contract APY | ", percent(saquon$second_apy_cap_pct, accuracy = 0.1),
    " | His second contract was only ", percent(saquon$second_apy_cap_pct, accuracy = 0.1),
    " of cap |\n",
  "| **Player return** | **", percent(saquon$player_return, accuracy = 0.1),
    "** | Rookie surplus + second contract = total value generated |\n",
  "| **Elite threshold** | **", percent(elite_threshold, accuracy = 0.1),
