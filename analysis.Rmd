...
Team-seasons bucketed into quintiles by **premium-position surplus** — the combined rookie-deal surplus generated by QB, OT, EDGE, WR, and CB picks on the active rookie class (drafts Y–4 to Y–1). These are the positions where the Sharpe ratio says expected surplus is highest; this chart asks whether teams that actually *realize* that surplus also win more.
...
ggplot(sw_quintile, aes(x = bin, y = value, color = metric, group = metric)) +
  ...
  labs(
    ...
    subtitle = paste0("Team-seasons bucketed into quintiles by premium-position surplus (QB / OT / EDGE / WR / CB, drafts Y–4 to Y–1) | 2014–2025, n = ",
                      nrow(sw_panel)),
...
cat(paste0(
  ...
  " team-seasons from 2014 to 2025, teams in the top quintile of premium-position surplus (QB/OT/EDGE/WR/CB) win **",
